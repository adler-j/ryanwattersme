...
//         ge = function(a, b, c) { 1 <= 100 * Math.random() || Aa("?") || (a = ["t=error", "_e=" + a, "_v=j41", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(oc() + "/collect", a.join("&"), ua)) };
...
//             try {
//                 return d && J(d), c.apply(this, arguments) } catch (b) {
//                 throw ge("exc", a, b && b.name), b; } } };
//     var Od = function(a, b, c) { this.V = 1E4;
//             this.fa = a;
//             this.$ = !1;
//             this.B = b;
//             this.ea = c || 1 },
...
//                     c = function() { 4 <= b && 6 >= b ? O.navigator.sendBeacon(e, "") : ta(e) };
//                     Bd() % 2 ? (ta(a), c()) : (c(), ta(a)) } } };
...
//         Fd = function(a) {
//             return function(b) { "pageview" != b.get(Va) || a.I || (a.I = !0, gc(b, function(b) { a.send("timing", b) })) } };
//     var hc = !1,
//         mc = function(a) {
//             if ("cookie" == P(a, ac)) {
//                 var b = P(a, U),
...
//                         g = g.parentNode;
//                         c-- }
//                     d = {} }("http:" == d.protocol || "https:" == d.protocol) && sd(a, d.hostname || "") && d.href && (d.href = qd(e, d.href, b)) } catch (w) { J(26) } }
//         var e = this;
...
//                         if (!c) return !0 } else if (a.K) {
//                     var ca = a.C,
//                         l = a.a,
//                         k = b.plugins_.get(a.K);
//                     k[ca].apply(k, l) } else b[a.C].apply(b, a.a) } } catch (w) {} };
...
//                         var d = b[c].src;
//                         if (d && 0 == d.indexOf("https://www.google-analytics.com/analytics")) { J(33);
//                             b = !0;
//                             break a } }
//                     b = !1
//                 }
...
// //Keep new and updated GOOGLE ANALYTICS CODE ABOVE
// //replacing embedded GA on page.
// (function() {
//     if (window.location.hostname === "localhost") {
//         console.log("Local dev No Google Analytics!");
//         return;
//     } else {
