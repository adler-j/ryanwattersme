...
! function() {
    function e() {
        var e = !1;
        if ("localStorage" in window) try { window.localStorage.setItem("_tmptest", "tmpval"), e = !0, window.localStorage.removeItem("_tmptest") } catch (t) {}
        if (e) try { window.localStorage && (w = window.localStorage, S = "localStorage", j = w.jStorage_update) } catch (a) {} else if ("globalStorage" in window) try { window.globalStorage && (w = window.globalStorage[window.location.hostname], S = "globalStorage", j = w.jStorage_update) } catch (o) {} else {
                if (C = document.createElement("link"), !C.addBehavior) return void(C = null);
                C.style.behavior = "url(#default#userData)", document.getElementsByTagName("head")[0].appendChild(C);
                try { C.load("jStorage") } catch (i) { C.setAttribute("jStorage", "{}"), C.save("jStorage"), C.load("jStorage") }
                var u = "{}";
                try { u = C.getAttribute("jStorage") } catch (l) {}
                try { j = C.getAttribute("jStorage_update") } catch (d) {}
                w.jStorage = u, S = "userDataBehavior" }
            s(), f(), r(), c(), "addEventListener" in window && window.addEventListener("pageshow", function(e) { e.persisted && n() }, !1) }

    function t() {
        var e = "{}";
        if ("userDataBehavior" == S) { C.load("jStorage");
            try { e = C.getAttribute("jStorage") } catch (t) {}
            try { j = C.getAttribute("jStorage_update") } catch (r) {}
            w.jStorage = e }
        s(), f(), c() }

    function r() { "localStorage" == S || "globalStorage" == S ? "addEventListener" in window ? window.addEventListener("storage", n, !1) : document.attachEvent("onstorage", n) : "userDataBehavior" == S && setInterval(n, 1e3) }

    function n() {
        var e;
        clearTimeout(P), P = setTimeout(function() {
            if ("localStorage" == S || "globalStorage" == S) e = w.jStorage_update;
            else if ("userDataBehavior" == S) { C.load("jStorage");
                try { e = C.getAttribute("jStorage_update") } catch (t) {} }
            e && e != j && (j = e, a()) }, 25) }

    function a() {
        var e, r = g.parse(g.stringify(b.__jstorage_meta.CRC32));
        t(), e = g.parse(g.stringify(b.__jstorage_meta.CRC32));
        var n, a = [],
            i = [];
        for (n in r)
            if (r.hasOwnProperty(n)) {
                if (!e[n]) { i.push(n);
                    continue }
                r[n] != e[n] && "2." == String(r[n]).substr(0, 2) && a.push(n) }
        for (n in e) e.hasOwnProperty(n) && (r[n] || a.push(n));
        o(a, "updated"), o(i, "deleted") }

    function o(e, t) {
        if (e = [].concat(e || []), "flushed" == t) { e = [];
            for (var r in k) k.hasOwnProperty(r) && e.push(r);
            t = "deleted" }
        for (var n = 0, a = e.length; a > n; n++) {
            if (k[e[n]])
                for (var o = 0, i = k[e[n]].length; i > o; o++) k[e[n]][o](e[n], t);
            if (k["*"])
                for (var o = 0, i = k["*"].length; i > o; o++) k["*"][o](e[n], t) } }

    function i() {
        var e = (+new Date).toString(); "localStorage" == S || "globalStorage" == S ? w.jStorage_update = e : "userDataBehavior" == S && (C.setAttribute("jStorage_update", e), C.save("jStorage")), n() }

    function s() {
        if (w.jStorage) try { b = g.parse(String(w.jStorage)) } catch (e) { w.jStorage = "{}" } else w.jStorage = "{}";
        O = w.jStorage ? String(w.jStorage).length : 0, b.__jstorage_meta || (b.__jstorage_meta = {}), b.__jstorage_meta.CRC32 || (b.__jstorage_meta.CRC32 = {}) }

    function u() { h();
        try { w.jStorage = g.stringify(b), C && (C.setAttribute("jStorage", w.jStorage), C.save("jStorage")), O = w.jStorage ? String(w.jStorage).length : 0 } catch (e) {} }
    ...
    function f() {
        var e, t, r, n, a = 1 / 0,
            s = !1,
            l = [];
        if (clearTimeout(_), b.__jstorage_meta && "object" == _typeof(b.__jstorage_meta.TTL)) { e = +new Date, r = b.__jstorage_meta.TTL, n = b.__jstorage_meta.CRC32;
            for (t in r) r.hasOwnProperty(t) && (r[t] <= e ? (delete r[t], delete n[t], delete b[t], s = !0, l.push(t)) : r[t] < a && (a = r[t]));
            a != 1 / 0 && (_ = setTimeout(f, a - e)), s && (u(), i(), o(l, "deleted")) } }

    function c() {
        var e, t;
        if (b.__jstorage_meta.PubSub) {
            var r, n = E;
            for (e = t = b.__jstorage_meta.PubSub.length - 1; e >= 0; e--) r = b.__jstorage_meta.PubSub[e], r[0] > E && (n = r[0], d(r[1], r[2]));
            E = n } }

    function d(e, t) {
        if (A[e])
            for (var r = 0, n = A[e].length; n > r; r++) A[e][r](e, g.parse(g.stringify(t))) }

    function h() {
        if (b.__jstorage_meta.PubSub) {
            for (var e = +new Date - 2e3, t = 0, r = b.__jstorage_meta.PubSub.length; r > t; t++)
                if (b.__jstorage_meta.PubSub[t][0] <= e) { b.__jstorage_meta.PubSub.splice(t, b.__jstorage_meta.PubSub.length - t);
                    break }
            b.__jstorage_meta.PubSub.length || delete b.__jstorage_meta.PubSub } }

    function p(e, t) { b.__jstorage_meta || (b.__jstorage_meta = {}), b.__jstorage_meta.PubSub || (b.__jstorage_meta.PubSub = []), b.__jstorage_meta.PubSub.unshift([+new Date, e, t]), u(), i() }

    function y(e, t) {
        for (var r, n = e.length, a = t ^ n, o = 0; n >= 4;) r = 255 & e.charCodeAt(o) | (255 & e.charCodeAt(++o)) << 8 | (255 & e.charCodeAt(++o)) << 16 | (255 & e.charCodeAt(++o)) << 24, r = 1540483477 * (65535 & r) + ((1540483477 * (r >>> 16) & 65535) << 16), r ^= r >>> 24, r = 1540483477 * (65535 & r) + ((1540483477 * (r >>> 16) & 65535) << 16), a = 1540483477 * (65535 & a) + ((1540483477 * (a >>> 16) & 65535) << 16) ^ r, n -= 4, ++o;
        switch (n) {
            case 3:
            ...
            case 1:
                a ^= 255 & e.charCodeAt(o), a = 1540483477 * (65535 & a) + ((1540483477 * (a >>> 16) & 65535) << 16) }
        return a ^= a >>> 13, a = 1540483477 * (65535 & a) + ((1540483477 * (a >>> 16) & 65535) << 16), a ^= a >>> 15, a >>> 0 }
    var v = "0.4.3",
        m = window.jQuery || window.$ || (window.$ = {}),
        g = { parse: window.JSON && (window.JSON.parse || window.JSON.decode) || String.prototype.evalJSON && function(e) {
                return String(e).evalJSON() } || m.parseJSON || m.evalJSON, stringify: Object.toJSON || window.JSON && (window.JSON.stringify || window.JSON.encode) || m.toJSON };
    if (!g.parse || !g.stringify) throw new Error("No JSON support found, include //cdnjs.cloudflare.com/ajax/libs/json2/20110223/json2.js to page");
    var _, b = { __jstorage_meta: { CRC32: {} } },
        w = { jStorage: "{}" },
        C = null,
        O = 0,
        S = !1,
        ...
        T = { isXML: function(e) {
                ...
                return t ? "HTML" !== t.nodeName : !1 }, encode: function(e) {
                if (!this.isXML(e)) return !1;
                try {
                    return (new XMLSerializer).serializeToString(e) } catch (t) {
                    try {
                        return e.xml } catch (r) {} }
                return !1 }, decode: function(e) {
    ...
    m.jStorage = { version: v, set: function(e, t, r) {
            if (l(e), r = r || {}, "undefined" == typeof t) return this.deleteKey(e), t;
            if (T.isXML(t)) t = { _is_xml: !0, xml: T.encode(t) };
            else {
                if ("function" == typeof t) return;
                t && "object" == ("undefined" == typeof t ? "undefined" : _typeof(t)) && (t = g.parse(g.stringify(t))) }
            return b[e] = t, b.__jstorage_meta.CRC32[e] = "2." + y(g.stringify(t), 2538058380), this.setTTL(e, r.TTL || 0), o(e, "updated"), t }, get: function(e, t) {
            return l(e), e in b ? b[e] && "object" == _typeof(b[e]) && b[e]._is_xml ? T.decode(b[e].xml) : b[e] : "undefined" == typeof t ? null : t }, deleteKey: function(e) {
            return l(e), e in b ? (delete b[e], "object" == _typeof(b.__jstorage_meta.TTL) && e in b.__jstorage_meta.TTL && delete b.__jstorage_meta.TTL[e], delete b.__jstorage_meta.CRC32[e], u(), i(), o(e, "deleted"), !0) : !1 }, setTTL: function(e, t) {
            var r = +new Date;
            return l(e), t = Number(t) || 0, e in b ? (b.__jstorage_meta.TTL || (b.__jstorage_meta.TTL = {}), t > 0 ? b.__jstorage_meta.TTL[e] = r + t : delete b.__jstorage_meta.TTL[e], u(), f(), i(), !0) : !1 }, getTTL: function(e) {
            var t, r = +new Date;
            return l(e), e in b && b.__jstorage_meta.TTL && b.__jstorage_meta.TTL[e] ? (t = b.__jstorage_meta.TTL[e] - r, t || 0) : 0 }, flush: function() {
            return b = { __jstorage_meta: { CRC32: {} } }, u(), i(), o(null, "flushed"), !0 }, storageObj: function() {
            function e() {}
            return e.prototype = b, new e }, index: function I() {
            var e, I = [];
            for (e in b) b.hasOwnProperty(e) && "__jstorage_meta" != e && I.push(e);
            return I }, storageSize: function() {
            return O }, currentBackend: function() {
            return S }, storageAvailable: function() {
            return !!S }, listenKeyChange: function(e, t) { l(e), k[e] || (k[e] = []), k[e].push(t) }, stopListening: function(e, t) {
            if (l(e), k[e]) {
                if (!t) return void delete k[e];
                for (var r = k[e].length - 1; r >= 0; r--) k[e][r] == t && k[e].splice(r, 1) } }, subscribe: function(e, t) {
            if (e = (e || "").toString(), !e) throw new TypeError("Channel not defined");
            A[e] || (A[e] = []), A[e].push(t) }, publish: function(e, t) {
            if (e = (e || "").toString(), !e) throw new TypeError("Channel not defined");
            p(e, t) }, reInit: function() { t() } }, e() }(),
function() {
    var e, t = function(e, t) {
        return function() {
            return e.apply(t, arguments) } };
    e = function() {
        function e(e) { this.element = e, this.unkudo = t(this.unkudo, this), this.complete = t(this.complete, this), this.end = t(this.end, this), this.start = t(this.start, this), this.bindEvents(), this.counter = $(".count .num", this.element), this.element.data("kudoable", this) }
        return e.prototype.bindEvents = function() { this.element.mouseenter(this.start), this.element.mouseleave(this.end), this.element.click(this.unkudo), this.element.on("touchstart", this.element, this.start), this.element.on("touchend", this.element, this.end) }, e.prototype.isKudoable = function() {
            return this.element.hasClass("kudoable") }, e.prototype.isKudod = function() {
            return this.element.hasClass("complete") }, e.prototype.start = function() {
            return this.isKudoable() && !this.isKudod() ? (this.element.trigger("kudo:active"), this.element.addClass("active"), this.timer = setTimeout(this.complete, 700)) : void 0 }, e.prototype.end = function() {
            return this.isKudoable() && !this.isKudod() && (this.element.trigger("kudo:inactive"), this.element.removeClass("active"), null != this.timer) ? clearTimeout(this.timer) : void 0 }, e.prototype.complete = function() {
            return this.end(), this.incrementCount(), this.element.addClass("complete"), this.element.trigger("kudo:added") }, e.prototype.unkudo = function(e) {
            return e.preventDefault(), this.isKudod() ? (this.decrementCount(), this.element.removeClass("complete"), this.element.trigger("kudo:removed")) : void 0 }, e.prototype.setCount = function(e) {
            return this.counter.html(e) }, e.prototype.currentCount = function() {
            return parseInt(this.counter.html()) }, e.prototype.incrementCount = function() {
            return this.setCount(this.currentCount() + 1) }, e.prototype.decrementCount = function() {
            return this.setCount(this.currentCount() - 1) }, e }(), $(function(t) {
        return t.fn.kudoable = function() {
            return this.each(function() {
                return new e(t(this)) }) } }) }.call(void 0), ! function(e) {
        ...
        return function e(t, r, n) {
            function a(i, s) {
                if (!r[i]) {
                    ...
                    t[i][0].call(f.exports, function(e) {
                        var r = t[i][1][e];
                        return a(r ? r : e) }, f, f.exports, e, t, r, n) }
                return r[i].exports }
            ...
            1: [function(e, t, r) {
                function n(e, t, r) {
                    ...
                    return r = r || {}, i["default"].getAnalyticsController().track(e, t)._thenRunCallbacks(r) }
                var a = e("babel-runtime/helpers/interop-require-default")["default"];
                Object.defineProperty(r, "__esModule", { value: !0 }), r.track = n;
                var o = e("./CoreManager"),
                    i = a(o);
                i["default"].setAnalyticsController({ track: function(e, t) {
                        var r = i["default"].getRESTController();
            ...
            2: [function(e, t, r) {
                function n(e, t, r) {
                    ...
                    var n = {};
                    return r.useMasterKey && (n.useMasterKey = r.useMasterKey), r.sessionToken && (n.sessionToken = r.sessionToken), i["default"].getCloudController().run(e, t, n)._thenRunCallbacks(r) }
                var a = e("babel-runtime/helpers/interop-require-default")["default"];
                ...
                var o = e("./CoreManager"),
                    ...
                    h = e("./ParsePromise"),
                    p = a(h);
                i["default"].setCloudController({ run: function(e, t, r) {
                        var n = i["default"].getRESTController(),
                            a = (0, f["default"])(t, !0),
                            o = {};
                        r.hasOwnProperty("useMasterKey") && (o.useMasterKey = r.useMasterKey), r.hasOwnProperty("sessionToken") && (o.sessionToken = r.sessionToken);
                        var s = n.request("POST", "functions/" + e, a, o);
            ...
            4: [function(e, t, r) {
                ...
                r["default"] = { init: function(e) {
                        ...
                        if (o.status && "undefined" != typeof console) {
                        ...
                        o.status = !1, FB.init(o), l["default"]._registerAuthenticationProvider({ authenticate: function(e) {
                                ...
                                if (e) {
                                    var t = (0, s["default"])(e.expiration_date),
                                ...
                                return "facebook" }, deauthenticate: function() { this.restoreAuthentication(null) } }), f = !0 }, isLinked: function(e) {
                        ...
                        if (!f) throw new Error("You must initialize FacebookUtils before calling logIn.");
                        ...
                        if (!f) throw new Error("You must initialize FacebookUtils before calling link.");
                        return a = t, e._linkWith("facebook", r) }, unlink: function(e, t) {
                        if (!f) throw new Error("You must initialize FacebookUtils before calling unlink.");
            ...
            5: [function(e, t, r) {
                ...
                var o = e("babel-runtime/helpers/interop-require-default")["default"],
                    i = e("./CoreManager"),
                    s = (o(i), e("./ParsePromise")),
                    u = o(s),
                    l = e("./Storage"),
                    f = o(l),
                    c = null;
                t.exports = { currentInstallationId: function() {
                        if ("string" == typeof c) return u["default"].as(c);
                        var e = f["default"].generatePath("installationId");
                        return f["default"].getItemAsync(e).then(function(t) {
                            return t ? (c = t, t) : (t = a(), f["default"].setItemAsync(e, t).then(function() {
                                return c = t, t })) }) }, _clearCache: function() { c = null }, _setInstallationIdCache: function(e) { c = e } } }, { "./CoreManager": 3, "./ParsePromise": 16, "./Storage": 24, "babel-runtime/helpers/interop-require-default": 47 }],
            6: [function(e, t, r) {
                function n(e, t) {
                    var r = N[e];
                ...
                function a(e, t, r) {
                    var a = n(e, t);
                    return a ? a : (N[e] || (N[e] = {}), r || (r = { serverData: {}, pendingOps: [{}], objectCache: {}, tasks: new T["default"], existed: !1 }), a = N[e][t] = r) }
                ...
                function s(e, t, r) {
                    ...
                    for (var o in r) "undefined" != typeof r[o] ? n[o] = r[o] : delete n[o] }
                ...
                function l(e, t, r, n) {
                    var o = a(e, t).pendingOps,
                        i = o.length - 1;
                    n ? o[i][r] = n : delete o[i][r] }
                ...
                function d(e, t) {
                    ...
                    for (var o in r)
                        if (a[o] && r[o]) {
                            var i = a[o].mergeWith(r[o]);
                            i && (a[o] = i) } else a[o] = r[o] }
                ...
                function p(e, t, r) {
                    for (var n = i(e, t), a = n[r], o = u(e, t), s = 0; s < o.length; s++) o[s][r] && (a = o[s][r] instanceof I.RelationOp ? o[s][r].applyTo(a, { className: e, id: t }, r) : o[s][r].applyTo(a));
                    return a }
                ...
                function y(e, t) {
                    var r, n = {},
                        a = i(e, t);
                    for (r in a) n[r] = a[r];
                    for (var o = u(e, t), s = 0; s < o.length; s++)
                        for (r in o[s]) o[s][r] instanceof I.RelationOp ? n[r] = o[s][r].applyTo(n[r], { className: e, id: t }, r) : n[r] = o[s][r].applyTo(n[r]);
                    return n }
                ...
                function v(e, t, r) {
                    ...
                    for (var o in r) {
                        var i = r[o];
                        if (n.serverData[o] = i, i && "object" == ("undefined" == typeof i ? "undefined" : _typeof(i)) && !(i instanceof k["default"]) && !(i instanceof O["default"]) && !(i instanceof A["default"])) {
                            var s = (0, w["default"])(i, !1, !0);
                            n.objectCache[o] = JSON.stringify(s) } } }
                ...
                Object.defineProperty(r, "__esModule", { value: !0 }), r.getState = n, r.initializeState = a, r.removeState = o, r.getServerData = i, r.setServerData = s, r.getPendingOps = u, r.setPendingOp = l, r.pushPendingState = f, r.popPendingState = c, r.mergeFirstPendingState = d, r.getObjectCache = h, r.estimateAttribute = p, r.estimateAttributes = y, r.commitServerChanges = v, r.enqueueTask = m, r._clearAllState = g;
                var b = e("./encode"),
                    w = _(b),
                    C = e("./ParseFile"),
                    O = _(C),
            ...
            7: [function(e, t, r) {
                var n = e("babel-runtime/helpers/interop-require-default")["default"],
                    ...
                    l = e("./CoreManager"),
                    f = n(l),
                    c = e("./InstallationController"),
                    d = n(c),
                    h = e("./ParseOp"),
                    p = a(h),
                    y = e("./RESTController"),
                    v = n(y),
                    m = { initialize: function(e, t) { f["default"].get("IS_NODE") && console.log("It looks like you're using the browser version of the SDK in a node.js environment. You should require('parse/node') instead."), m._initialize(e, t) }, _initialize: function(e, t, r) { f["default"].set("APPLICATION_ID", e), f["default"].set("JAVASCRIPT_KEY", t), f["default"].set("MASTER_KEY", r), f["default"].set("USE_MASTER_KEY", !1) } };
                Object.defineProperty(m, "applicationId", { get: function() {
                        return f["default"].get("APPLICATION_ID") }, set: function(e) { f["default"].set("APPLICATION_ID", e) } }), Object.defineProperty(m, "javaScriptKey", { get: function() {
                        return f["default"].get("JAVASCRIPT_KEY") }, set: function(e) { f["default"].set("JAVASCRIPT_KEY", e) } }), Object.defineProperty(m, "masterKey", { get: function() {
                        return f["default"].get("MASTER_KEY") }, set: function(e) { f["default"].set("MASTER_KEY", e) } }), Object.defineProperty(m, "serverURL", { get: function() {
                        return f["default"].get("SERVER_URL") }, set: function(e) { f["default"].set("SERVER_URL", e) } }), m.ACL = e("./ParseACL"), m.Analytics = e("./Analytics"), m.Cloud = e("./Cloud"), m.CoreManager = e("./CoreManager"), m.Config = e("./ParseConfig"), m.Error = e("./ParseError"), m.FacebookUtils = e("./FacebookUtils"), m.File = e("./ParseFile"), m.GeoPoint = e("./ParseGeoPoint"), m.Installation = e("./ParseInstallation"), m.Object = e("./ParseObject"), m.Op = { Set: p.SetOp, Unset: p.UnsetOp, Increment: p.IncrementOp, Add: p.AddOp, Remove: p.RemoveOp, AddUnique: p.AddUniqueOp, Relation: p.RelationOp }, m.Promise = e("./ParsePromise"), m.Push = e("./Push"), m.Query = e("./ParseQuery"), m.Relation = e("./ParseRelation"), m.Role = e("./ParseRole"), m.Session = e("./ParseSession"), m.Storage = e("./Storage"), m.User = e("./ParseUser"), m._request = function() {
                    for (var e = arguments.length, t = Array(e), r = 0; e > r; r++) t[r] = arguments[r];
                    return f["default"].getRESTController().request.apply(null, t) }, m._ajax = function() {
                    for (var e = arguments.length, t = Array(e), r = 0; e > r; r++) t[r] = arguments[r];
                    return f["default"].getRESTController().ajax.apply(null, t) }, m._decode = function(e, t) {
                    return (0, i["default"])(t) }, m._encode = function(e, t, r) {
                    return (0, u["default"])(e, r) }, m._getInstallationId = function() {
                    return f["default"].getInstallationController().currentInstallationId() }, f["default"].setInstallationController(d["default"]), f["default"].setRESTController(v["default"]), m.Parse = m, t.exports = m }, { "./Analytics": 1, "./Cloud": 2, "./CoreManager": 3, "./FacebookUtils": 4, "./InstallationController": 5, "./ParseACL": 8, "./ParseConfig": 9, "./ParseError": 10, "./ParseFile": 11, "./ParseGeoPoint": 12, "./ParseInstallation": 13, "./ParseObject": 14, "./ParseOp": 15, "./ParsePromise": 16, "./ParseQuery": 17, "./ParseRelation": 18, "./ParseRole": 19, "./ParseSession": 20, "./ParseUser": 21, "./Push": 22, "./RESTController": 23, "./Storage": 24, "./decode": 29, "./encode": 30, "babel-runtime/helpers/interop-require-default": 47, "babel-runtime/helpers/interop-require-wildcard": 48 }],
            8: [function(e, t, r) {
                ...
                var s = e("./ParseRole"),
                    ...
                    d = function() {
                        function e(t) {
                            if (a(this, e), this.permissionsById = {}, t && "object" == ("undefined" == typeof t ? "undefined" : _typeof(t)))
                                if (t instanceof f["default"]) this.setReadAccess(t, !0), this.setWriteAccess(t, !0);
                                else
                                    for (var r in t) {
                                        var n = t[r];
                                        ...
                                        for (var o in n) {
                                            ...
                                            if ("boolean" != typeof i) throw new TypeError("Tried to create an ACL with an invalid permission value.");
                                            this.permissionsById[r][o] = i } } else if ("function" == typeof t) throw new TypeError("ParseACL constructed with a function. Did you forget ()?") }
                        return n(e, [{ key: "toJSON", value: function() {
                                ...
                                var r = o(this.permissionsById),
                                    n = o(t.permissionsById);
                                ...
                                if (t instanceof f["default"] ? t = t.id : t instanceof u["default"] && (t = "role:" + t.getName()), "string" != typeof t) throw new TypeError("userId must be a string.");
                                ...
                                r ? this.permissionsById[t][e] = !0 : (delete n[e], 0 === o(n).length && delete this.permissionsById[t]) } }, { key: "_getAccess", value: function(e, t) { t instanceof f["default"] ? t = t.id : t instanceof u["default"] && (t = "role:" + t.getName());
                                ...
                                return this._getAccess("write", e) } }, { key: "setPublicReadAccess", value: function(e) { this.setReadAccess(c, e) } }, { key: "getPublicReadAccess", value: function() {
                                return this.getReadAccess(c) } }, { key: "setPublicWriteAccess", value: function(e) { this.setWriteAccess(c, e) } }, { key: "getPublicWriteAccess", value: function() {
                                return this.getWriteAccess(c) } }, { key: "getRoleReadAccess", value: function(e) {
            ...
            9: [function(e, t, r) {
                function n(e) {
                    try {
                        var t = JSON.parse(e);
                        if (t && "object" == ("undefined" == typeof t ? "undefined" : _typeof(t))) return (0, f["default"])(t) } catch (r) {
                        return null } }
                ...
                var s = e("./CoreManager"),
                    ...
                    _ = i(g),
                    b = function() {
                        function e() { o(this, e), this.attributes = {}, this._escapedAttributes = {} }
                ...
                u["default"].setConfigController({
                    ...
                    get: function() {
                        ...
                        return e.request("GET", "config", {}, {}).then(function(e) {
                            ...
                            var r = new b;
                            r.attributes = {};
                            for (var n in e.params) r.attributes[n] = (0,
                                f["default"])(e.params[n]);
                            return w = r, _["default"].setItemAsync(_["default"].generatePath(C), JSON.stringify(e.params)).then(function() {
                                return r })
                        })
                    }
                }), t.exports = r["default"]
            ...
            10: [function(e, t, r) {
                ...
                Object.defineProperty(r, "__esModule", { value: !0 });
                var a = function o(e, t) { n(this, o), this.code = e, this.message = t };
                    ...
                    f = (i(l), function() {
                        function e(t, r, n) { o(this, e);
                            ...
                            if (this._name = t, Array.isArray(r)) this._source = { format: "base64", base64: e.encodeBase64(r), type: a };
                                ...
                                var i = /^data:([a-zA-Z]*\/[a-zA-Z+.-]*);(charset=[a-zA-Z0-9\-\/\s]*,)?base64,(\S+)/.exec(r.base64);
                                i && i.length > 0 ? this._source = { format: "base64", base64: 4 === i.length ? i[3] : i[2], type: i[1] } : this._source = { format: "base64", base64: r.base64, type: a } } else if ("undefined" != typeof r) throw new TypeError("Cannot create a Parse.File with that data.") }
                        return a(e, [{ key: "name", value: function() {
                                ...
                                for (var r = 0; r < t.length; r++) {
                                    var a = e[3 * r],
                                        ...
                                        s = 3 * r + 1 < e.length,
                                        u = 3 * r + 2 < e.length;
                                    t[r] = [n(a >> 2 & 63), n(a << 4 & 48 | o >> 4 & 15), s ? n(o << 2 & 60 | i >> 6 & 3) : "=", u ? n(63 & i) : "="].join("") }
                                return t.join("") } }]), e }());
                r["default"] = f, u["default"].setFileController({ saveFile: function(e, t) {
                    ...
                    u = function() {
                        ...
                        return n(e, [{ key: "toJSON", value: function() {
                                ...
                                var t = Math.PI / 180,
                                    ...
                                    i = Math.sin((r - a) / 2),
                                    s = Math.sin((n - o) / 2),
                                    u = i * i + Math.cos(r) * Math.cos(a) * s * s;
            ...
            13: [function(e, t, r) {
                ...
                var s = e("./ParseObject"),
                    ...
                    l = function(e) {
                        function t(e) {
                            if (o(this, t), n(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, "_Installation"), e && "object" == ("undefined" == typeof e ? "undefined" : _typeof(e)) && !this.set(e || {})) throw new Error("Can't create an invalid Session") }
            ...
            14: [function(e, t, r) {
                ...
                var d = e("./CoreManager"),
                    ...
                    z = function() {
                        function e(t, r, n) { o(this, e), "function" == typeof this.initialize && this.initialize.apply(this, arguments);
                            var a = null;
                            if (this._objCount = G++, "string" == typeof t) this.className = t, r && "object" == ("undefined" == typeof r ? "undefined" : _typeof(r)) && (a = r);
                            else if (t && "object" == ("undefined" == typeof t ? "undefined" : _typeof(t))) { this.className = t.className, a = {};
                                for (var i in t) "className" !== i && (a[i] = t[i]);
                                r && "object" == ("undefined" == typeof r ? "undefined" : _typeof(r)) && (n = r) }
                        ...
                        return a(e, [{ key: "_getId", value: function() {
                                ...
                                return S.getServerData(this.className, this._getStateIdentifier()) } }, { key: "_clearServerData", value: function() {
                                var e = this._getServerData(),
                                    t = {};
                                for (var r in e) t[r] = void 0;
                                S.setServerData(this.className, this._getStateIdentifier(), t) } }, { key: "_getPendingOps", value: function() {
                                return S.getPendingOps(this.className, this._getStateIdentifier()) } }, { key: "_clearPendingOps", value: function() {
                                var e = this._getPendingOps(),
                                    t = e[e.length - 1],
                                    r = i(t);
                                r.forEach(function(e) { delete t[e] }) } }, { key: "_getDirtyObjectAttributes", value: function() {
                                var t = this.attributes,
                                    r = S.getObjectCache(this.className, this._getStateIdentifier()),
                                    n = {};
                                for (var a in t) {
                                    var o = t[a];
                                    if (o && "object" == ("undefined" == typeof o ? "undefined" : _typeof(o)) && !(o instanceof e) && !(o instanceof N["default"]) && !(o instanceof L["default"])) try {
                                        var i = (0, _["default"])(o, !1, !0),
                                            s = JSON.stringify(i);
                                        r[a] !== s && (n[a] = o) } catch (u) { n[a] = o } }
                                ...
                                return this.id ? r += "/" + this.id : "_User" === this.className && (r = "users"), { method: e, body: t, path: r } } }, { key: "_finishFetch", value: function(e) {!this.id && e.objectId && (this.id = e.objectId), S.initializeState(this.className, this._getStateIdentifier());
                                var t = {};
                                for (var r in e) "ACL" === r ? t[r] = new P["default"](e[r]) : "objectId" !== r && (t[r] = (0, m["default"])(e[r]), t[r] instanceof L["default"] && t[r]._ensureParentAndKey(this, r));
                                t.createdAt && "string" == typeof t.createdAt && (t.createdAt = (0, A["default"])(t.createdAt)), t.updatedAt && "string" == typeof t.updatedAt && (t.updatedAt = (0, A["default"])(t.updatedAt)), !t.updatedAt && t.createdAt && (t.updatedAt = t.createdAt), S.commitServerChanges(this.className, this._getStateIdentifier(), t) } }, { key: "_setExisted", value: function(e) {
                                var t = S.getState(this.className, this._getStateIdentifier());
                                t && (t.existed = e) } }, { key: "_migrateId", value: function(e) {
                                if (this._localId && e) {
                                    var t = S.removeState(this.className, this._getStateIdentifier());
                                    this.id = e, delete this._localId, t && S.initializeState(this.className, this._getStateIdentifier(), t) } } }, { key: "_handleSaveResponse", value: function(e, t) {
                                var r, n = {},
                                    a = S.popPendingState(this.className, this._getStateIdentifier());
                                for (r in a) a[r] instanceof R.RelationOp ? n[r] = a[r].applyTo(void 0, this, r) : r in e || (n[r] = a[r].applyTo(void 0));
                                for (r in e) "createdAt" !== r && "updatedAt" !== r || "string" != typeof e[r] ? "ACL" === r ? n[r] = new P["default"](e[r]) : "objectId" !== r && (n[r] = (0, m["default"])(e[r])) : n[r] = (0, A["default"])(e[r]);
                                n.createdAt && !n.updatedAt && (n.updatedAt = n.createdAt), this._migrateId(e.objectId), 201 !== t && this._setExisted(!0), S.commitServerChanges(this.className, this._getStateIdentifier(), n) } }, { key: "_handleSaveError", value: function() { this._getPendingOps(), S.mergeFirstPendingState(this.className, this._getStateIdentifier()) } }, { key: "initialize", value: function() {} }, { key: "toJSON", value: function(e) {
                                ...
                                var o = this._getPendingOps();
                                for (var a in o[0]) r[a] = o[0][a].toJSON();
                                ...
                                if (e) {
                                    ...
                                    return !1 }
                                return 0 !== i(t[0]).length ? !0 : 0 !== i(r).length ? !0 : !1 } }, { key: "dirtyKeys", value: function() {
                                ...
                                return i(t) } }, { key: "toPointer", value: function() {
                                ...
                                if ("string" != typeof t) {
                                    ...
                                    t = t.toString() }
                                return (0, C["default"])(t) } }, { key: "has", value: function(e) {
                                var t = this.attributes;
                                return t.hasOwnProperty(e) ? null != t[e] : !1 } }, { key: "set", value: function(e, t, r) {
                                var n = {},
                                    a = {};
                                if (e && "object" == ("undefined" == typeof e ? "undefined" : _typeof(e))) n = e, r = t;
                                else {
                                    if ("string" != typeof e) return this;
                                    n[e] = t }
                                r = r || {};
                                var o = []; "function" == typeof this.constructor.readOnlyAttributes && (o = o.concat(this.constructor.readOnlyAttributes()));
                                for (var i in n)
                                    if ("createdAt" !== i && "updatedAt" !== i) {
                                        if (o.indexOf(i) > -1) throw new Error("Cannot modify readonly attribute: " + i);
                                        r.unset ? a[i] = new R.UnsetOp : n[i] instanceof R.Op ? a[i] = n[i] : n[i] && "object" == _typeof(n[i]) && "string" == typeof n[i].__op ? a[i] = (0, R.opFromJSON)(n[i]) : "objectId" === i || "id" === i ? this.id = n[i] : "ACL" !== i || "object" != _typeof(n[i]) || n[i] instanceof P["default"] ? a[i] = new R.SetOp(n[i]) : a[i] = new R.SetOp(new P["default"](n[i])) }
                                var s = this.attributes,
                                    u = {};
                                for (var l in a) a[l] instanceof R.RelationOp ? u[l] = a[l].applyTo(s[l], this, l) : a[l] instanceof R.UnsetOp || (u[l] = a[l].applyTo(s[l]));
                                if (!r.ignoreValidation) {
                                    var f = this.validate(u);
                                    if (f) return "function" == typeof r.error && r.error(this, f), !1 }
                                var c = this._getPendingOps(),
                                    d = c.length - 1;
                                for (var l in a) {
                                    var h = a[l].mergeWith(c[d][l]);
                                    S.setPendingOp(this.className, this._getStateIdentifier(), l, h) }
                                ...
                                if (!this.id) return !1;
                                var e = S.getState(this.className, this._getStateIdentifier());
                                return e ? e.existed : !1 } }, { key: "isValid", value: function() {
                                return !this.validate(this.attributes) } }, { key: "validate", value: function(e) {
                                if (e.hasOwnProperty("ACL") && !(e.ACL instanceof P["default"])) return new T["default"](T["default"].OTHER_CAUSE, "ACL must be a Parse ACL.");
                                for (var t in e)
                                    if (!/^[A-Za-z][0-9A-Za-z_]*$/.test(t)) return new T["default"](T["default"].INVALID_KEY_NAME);
                                return !1 } }, { key: "getACL", value: function() {
                                var e = this.get("ACL");
                                return e instanceof P["default"] ? e : null } }, { key: "setACL", value: function(e, t) {
                                ...
                                var n, a, o = this;
                                if ("object" == ("undefined" == typeof e ? "undefined" : _typeof(e)) || "undefined" == typeof e ? (n = e, a = t) : (n = {}, n[e] = t, a = r), !a && n && (a = {}, "function" == typeof n.success && (a.success = n.success, delete n.success), "function" == typeof n.error && (a.error = n.error, delete n.error)), n) {
                                    var i = this.validate(n);
                                    if (i) return a && "function" == typeof a.error && a.error(this, i), D["default"].error(i);
                                    this.set(n, a) }
                                a = a || {};
                                var s = {};
                                a.hasOwnProperty("useMasterKey") && (s.useMasterKey = a.useMasterKey), a.hasOwnProperty("sessionToken") && (s.sessionToken = a.sessionToken);
                                var u = h["default"].getObjectController(),
                                    l = (0, J["default"])(this);
                                return u.save(l, s).then(function() {
                                    return u.save(o, s) })._thenRunCallbacks(a, this) } }, { key: "destroy", value: function(e) { e = e || {};
                                var t = {};
                                return e.hasOwnProperty("useMasterKey") && (t.useMasterKey = e.useMasterKey), e.hasOwnProperty("sessionToken") && (t.sessionToken = e.sessionToken), this.id ? h["default"].getObjectController().destroy(this, t)._thenRunCallbacks(e) : D["default"].as()._thenRunCallbacks(e) } }, { key: "attributes", get: function() {
                                return s(S.estimateAttributes(this.className, this._getStateIdentifier())) } }, { key: "createdAt", get: function() {
                                return this._getServerData().createdAt } }, { key: "updatedAt", get: function() {
                                return this._getServerData().updatedAt } }], [{ key: "_clearAllState", value: function() { S._clearAllState() } }, { key: "fetchAll", value: function(e, t) {
                                var t = t || {},
                                    r = {};
                                ...
                                var r = B[t.className],
                                    ...
                                    a = {};
                                for (var o in t) "className" !== o && "__type" !== o && (a[o] = t[o]);
                                ...
                                B[e] = t, t.className || (t.className = e) } }, { key: "extend", value: function(t, r, n) {
                                if ("string" != typeof t) {
                                ...
                                var o = e.prototype;
                                this.hasOwnProperty("__super__") && this.__super__ ? o = this.prototype : B[a] && (o = B[a].prototype);
                                var i = function(e, t) {
                                    if ("function" == typeof this.initialize && this.initialize.apply(this, arguments), this.className = a, this._objCount = G++, e && "object" == ("undefined" == typeof e ? "undefined" : _typeof(e)) && !this.set(e || {}, t)) throw new Error("Can't create an invalid Parse Object") };
                                if (i.className = a, i.__super__ = o, i.prototype = u(o, { constructor: { value: i, enumerable: !1, writable: !0, configurable: !0 } }), r)
                                    for (var s in r) "className" !== s && l(i.prototype, s, { value: r[s], enumerable: !1, writable: !0, configurable: !0 });
                                if (n)
                                    for (var s in n) "className" !== s && l(i, s, { value: n[s], enumerable: !1, writable: !0, configurable: !0 });
                                return i.extend = function(t, r, n) {
                                    return "string" == typeof t ? e.extend.call(i, t, r, n) : e.extend.call(i, a, t, r) }, i.createWithoutData = e.createWithoutData, B[a] = i, i } }, { key: "enableSingleInstance", value: function() { V = !0 } }, { key: "disableSingleInstance", value: function() { V = !1 } }]), e }();
                r["default"] = z, h["default"].setObjectController({ fetch: function(e, t, r) {
                        if (Array.isArray(e)) {
                            if (e.length < 1) return D["default"].as([]);
                            var n = [],
                                a = [],
                                o = null,
                                s = [],
                                u = null;
                            if (e.forEach(function(e, r) { u || (o || (o = e.className), o !== e.className && (u = new T["default"](T["default"].INVALID_CLASS_NAME, "All objects should be of the same class")), e.id || (u = new T["default"](T["default"].MISSING_OBJECT_ID, "All objects must have an ID")), (t || 0 === i(e._getServerData()).length) && (a.push(e.id), n.push(e)), s.push(e)) }), u) return D["default"].error(u);
                            ...
                            return l.containedIn("objectId", a), l._limit = a.length, l.find(r).then(function(e) {
                                ...
                                for (var a = 0; a < n.length; a++) {
                                    var o = n[a];
                                    if ((!o || !o.id || !r[o.id]) && t) return D["default"].error(new T["default"](T["default"].OBJECT_NOT_FOUND, "All objects must exist on the server.")) }
                                if (!V)
                                    for (var a = 0; a < s.length; a++) {
                                        var o = s[a];
                                        if (o && o.id && r[o.id]) {
                                            var i = o.id;
                                            o._finishFetch(r[i].toJSON()), s[a] = r[i] } }
                                return D["default"].as(s) }) }
                        var f = h["default"].getRESTController();
                        return f.request("GET", "classes/" + e.className + "/" + e._getId(), {}, r).then(function(t, r, n) {
                        ...
                        if (Array.isArray(e)) {
                            ...
                            var o = D["default"].as(),
                                i = [];
                            return a.forEach(function(e) { o = o.then(function() {
                                    return r.request("POST", "batch", { requests: e.map(function(e) {
                                        ...
                                        for (var r = 0; r < t.length; r++)
                                            if (t[r] && t[r].hasOwnProperty("error")) {
                                                var n = new T["default"](t[r].error.code, t[r].error.error);
                                                n.object = e[r], i.push(n) } }) }) }), o.then(function() {
                                if (i.length) {
                                    var t = new T["default"](T["default"].AGGREGATE_ERROR);
                                    return t.errors = i, D["default"].error(t) }
                                return D["default"].as(e) }) }
                        return e instanceof z ? r.request("DELETE", "classes/" + e.className + "/" + e._getId(), {}, t).then(function() {
                            return D["default"].as(e) }) : D["default"].as(e) }, save: function(e, t) {
                        var r = h["default"].getRESTController();
                        if (Array.isArray(e)) {
                            if (e.length < 1) return D["default"].as([]);
                            for (var a = e.concat(), o = 0; o < e.length; o++) e[o] instanceof z && (a = a.concat((0, J["default"])(e[o], !0)));
                            a = (0, F["default"])(a);
                            var i = D["default"].as(),
                                s = [];
                            return a.forEach(function(e) { e instanceof N["default"] ? i = i.then(function() {
                                    return e.save() }) : e instanceof z && s.push(e) }), i.then(function() {
                                var a = null;
                                return D["default"]._continueWhile(function() {
                                    return s.length > 0 }, function() {
                                    var e = [],
                                        o = [];
                                    if (s.forEach(function(t) { e.length < 20 && (0, y["default"])(t) ? e.push(t) : o.push(t) }), s = o, e.length < 1) return D["default"].error(new T["default"](T["default"].OTHER_CAUSE, "Tried to save a batch with a cycle."));
                                    var i = new D["default"],
                                        u = [],
                                        l = [];
            ...
            15: [function(e, t, r) {
                function n(e) {
                    ...
                    switch (e.__op) {
                        ...
                        case "AddUnique":
                            return new P((0, d["default"])(e.objects));
                        case "Remove":
                            return new j((0, d["default"])(e.objects));
                        case "AddRelation":
                            var t = (0, d["default"])(e.objects);
                            return Array.isArray(t) ? new A(t, []) : new A([], []);
                        case "RemoveRelation":
                            var r = (0, d["default"])(e.objects);
                            return Array.isArray(r) ? new A([], r) : new A([], []);
                        case "Batch":
                ...
                r.Op = w;
                var C = function(e) {
                    function t(e) { o(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this._value = e }
                    return s(t, e), a(t, [{ key: "applyTo", value: function(e) {
                ...
                r.SetOp = C;
                var O = function(e) {
                    function t() { o(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).apply(this, arguments) }
                    return s(t, e), a(t, [{ key: "applyTo", value: function(e) {} }, { key: "mergeWith", value: function(e) {
                            return new t } }, { key: "toJSON", value: function() {
                            return { __op: "Delete" } } }]), t }(w);
                r.UnsetOp = O;
                var S = function(e) {
                    function t(e) {
                        if (o(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), "number" != typeof e) throw new TypeError("Increment Op must be initialized with a numeric amount.");
                        this._amount = e }
                    return s(t, e), a(t, [{ key: "applyTo", value: function(e) {
                            ...
                            if (!e) return this;
                            if (e instanceof C) return new C(this.applyTo(e._value));
                            if (e instanceof O) return new C(this._amount);
                ...
                r.IncrementOp = S;
                var k = function(e) {
                    function t(e) { o(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this._value = Array.isArray(e) ? e : [e] }
                    return s(t, e), a(t, [{ key: "applyTo", value: function(e) {
                ...
                r.AddOp = k;
                var P = function(e) {
                    function t(e) { o(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this._value = (0, b["default"])(Array.isArray(e) ? e : [e]) }
                    return s(t, e), a(t, [{ key: "applyTo", value: function(e) {
                            if (null == e) return this._value || [];
                            if (Array.isArray(e)) {
                                var t = e,
                                    r = [];
                                return this._value.forEach(function(e) { e instanceof v["default"] ? (0, f["default"])(t, e) || r.push(e) : t.indexOf(e) < 0 && r.push(e) }), e.concat(r) }
                        ...
                        value: function(e) {
                            ...
                            return { __op: "AddUnique", objects: (0, p["default"])(this._value, !1, !0) } } }]), t
                }(w);
                r.AddUniqueOp = P;
                var j = function(e) {
                    function t(e) { o(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this._value = (0, b["default"])(Array.isArray(e) ? e : [e]) }
                    return s(t, e), a(t, [{ key: "applyTo", value: function(e) {
                            ...
                            if (!e) return this;
                            if (e instanceof C) return new C(this.applyTo(e._value));
                            if (e instanceof O) return new O;
                            if (e instanceof t) {
                                for (var r = e._value.concat([]), n = 0; n < this._value.length; n++) this._value[n] instanceof v["default"] ? (0, f["default"])(r, this._value[n]) || r.push(this._value[n]) : r.indexOf(this._value[n]) < 0 && r.push(this._value[n]);
                                return new t(r) }
                ...
                r.RemoveOp = j;
                var A = function(e) {
                    function t(e, r) { o(this, t), i(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this._targetClassName = null, Array.isArray(e) && (this.relationsToAdd = (0, b["default"])(e.map(this._extractId, this))), Array.isArray(r) && (this.relationsToRemove = (0, b["default"])(r.map(this._extractId, this))) }
                    return s(t, e), a(t, [{ key: "_extractId", value: function(e) {
                            ...
                            if (!e) return this;
                            if (e instanceof O) throw new Error("You cannot modify a relation after deleting it.");
                            if (e instanceof t) {
            ...
            16: [function(e, t, r) {
                (function(n) {
                    ...
                    var i = !1,
                        s = function() {
                            function e() { o(this, e), this._resolved = !1, this._rejected = !1, this._resolvedCallbacks = [], this._rejectedCallbacks = [] }
                            return a(e, [{ key: "resolve", value: function() {
                                    ...
                                    var a = this,
                                        ...
                                        s = function f() {
                                            ...
                                            if ("function" == typeof t)
                                                if (i) try { n = [t.apply(this, n)] } catch (f) { n = [e.error(f)] } else n = [t.apply(this, n)];
                                            1 === n.length && e.is(n[0]) ? n[0].then(function() { o.resolve.apply(o, arguments) }, function(e) { o.reject(e) }) : o.resolve.apply(o, n) },
                                        u = function(t) {
                                            var n = [];
                                            if ("function" == typeof r) {
                                                if (i) try { n = [r(t)] } catch (a) { n = [e.error(a)] } else n = [r(t)];
                                                1 === n.length && e.is(n[0]) ? n[0].then(function() { o.resolve.apply(o, arguments) }, function(e) { o.reject(e) }) : i ? o.resolve.apply(o, n) : o.reject(n[0]) } else o.reject(t) },
                                        l = function(e) { e.call() };
                                    return i && ("undefined" != typeof n && "function" == typeof n.nextTick ? l = function(e) { n.nextTick(e) } : "function" == typeof setTimeout && (l = function(e) { setTimeout(e, 0) })), this._resolved ? l(function() { s.apply(a, a._result) }) : this._rejected ? l(function() { u(a._error) }) : (this._resolvedCallbacks.push(s), this._rejectedCallbacks.push(u)), o } }, { key: "always", value: function(e) {
                                    ...
                                    var n = {};
                                    return "function" == typeof t ? (n.success = function(e) { t(e, null) }, n.error = function(e) { t(null, e) }) : "object" == ("undefined" == typeof t ? "undefined" : _typeof(t)) && ("function" == typeof t.success && (n.success = t.success), "function" == typeof t.error && (n.error = t.error)), this.then(function() {
                                    ...
                                    var n = r.length,
                                        ...
                                        o = [],
                                        i = [];
                                    if (o.length = r.length, i.length = r.length, 0 === n) return e.as.apply(this, o);
                                    for (var s = new e, u = function() { n--, 0 >= n && (a ? s.reject(i) : s.resolve.apply(s, o)) }, l = function(t, r) { e.is(t) ? t.then(function(e) { o[r] = e, u() }, function(e) { i[r] = e, a = !0, u() }) : (o[f] = t, u()) }, f = 0; f < r.length; f++) l(r[f], f);
                                    return s } }, { key: "_continueWhile", value: function(t, r) {
                                    return t() ? r().then(function() {
                                        return e._continueWhile(t, r) }) : e.as() } }, { key: "isPromisesAPlusCompliant", value: function() {
                                    return i } }, { key: "enableAPlusCompliant", value: function() { i = !0 } }, { key: "disableAPlusCompliant", value: function() { i = !1 } }]), e }();
                    r["default"] = s, t.exports = r["default"] }).call(this, e("_process")) }, { _process: 75, "babel-runtime/helpers/class-call-check": 43, "babel-runtime/helpers/create-class": 44 }],
            17: [function(e, t, r) {
                function n(e) {
                ...
                var s = e("./CoreManager"),
                    ...
                    _ = function() {
                        function e(t) {
                            if (o(this, e), "string" == typeof t) "User" === t && u["default"].get("PERFORM_USER_REWRITE") ? this.className = "_User" : this.className = t;
                        ...
                        return a(e, [{ key: "_orQuery", value: function(e) {
                                ...
                                return this._where[e] && "string" != typeof this._where[e] || (this._where[e] = {}), this._where[e][t] = (0, f["default"])(r, !1, !0), this } }, { key: "toJSON", value: function() {
                                ...
                                return e } }, { key: "get", value: function(e, t) { this.equalTo("objectId", e);
                                var r = {};
                                return t && t.hasOwnProperty("useMasterKey") && (r.useMasterKey = t.useMasterKey), t && t.hasOwnProperty("sessionToken") && (r.sessionToken = t.sessionToken), this.first(r).then(function(e) {
                                    ...
                                    return g["default"].error(t) })._thenRunCallbacks(t, null) } }, { key: "find", value: function(e) {
                                var t = this;
                                e = e || {};
                                var r = {};
                                ...
                                return a.limit = 1, n.find(this.className, a, r).then(function(e) {
                                    var r = e.results;
                                    return r[0] ? (r[0].className || (r[0].className = t.className), v["default"].fromJSON(r[0])) : void 0 })._thenRunCallbacks(e) } }, { key: "each", value: function(t, r) {
                                if (r = r || {}, this._order || this._skip || this._limit >= 0) return g["default"].error("Cannot iterate on a query with sort, skip, or limit.")._thenRunCallbacks(r);
                                var n = (new g["default"], new e(this.className));
                                ...
                                for (var a in this._where) {
                                    var o = this._where[a];
                                    if (Array.isArray(o)) n._where[a] = o.map(function(e) {
                                        return e });
                                    else if (o && "object" == ("undefined" == typeof o ? "undefined" : _typeof(o))) {
                                        var i = {};
                                        n._where[a] = i;
                                        for (var s in o) i[s] = o[s] } else n._where[a] = o }
                                ...
                                var l = !1;
                                return g["default"]._continueWhile(function() {
                                    return !l }, function() {
                                ...
                                return "undefined" == typeof t ? this.doesNotExist(e) : (this._where[e] = (0, f["default"])(t, !1, !0), this) } }, { key: "notEqualTo", value: function(e, t) {
                                ...
                                var o = new e(t);
                                return o._orQuery(n), o } }]), e }();
                r["default"] = _, u["default"].setQueryController({ find: function(e, t, r) {
                        var n = u["default"].getRESTController();
                        return n.request("GET", "classes/" + e, t, r) } }), t.exports = r["default"] }, { "./CoreManager": 3, "./ParseError": 10, "./ParseGeoPoint": 12, "./ParseObject": 14, "./ParsePromise": 16, "./encode": 30, "babel-runtime/helpers/class-call-check": 43, "babel-runtime/helpers/create-class": 44, "babel-runtime/helpers/interop-require-default": 47 }],
            18: [function(e, t, r) {
                var n = e("babel-runtime/helpers/create-class")["default"],
                    a = e("babel-runtime/helpers/class-call-check")["default"],
                    o = e("babel-runtime/helpers/interop-require-default")["default"];
                ...
                r["default"] = f, t.exports = r["default"] }, { "./ParseObject": 14, "./ParseOp": 15, "./ParseQuery": 17, "babel-runtime/helpers/class-call-check": 43, "babel-runtime/helpers/create-class": 44, "babel-runtime/helpers/interop-require-default": 47 }],
            19: [function(e, t, r) {
                var n = e("babel-runtime/helpers/get")["default"],
                    a = e("babel-runtime/helpers/inherits")["default"],
                ...
                var u = e("./ParseACL"),
                    ...
                    h = s(d),
                    p = function(e) {
                        function t(e, r) { i(this, t), n(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, "_Role"), "string" == typeof e && r instanceof l["default"] && (this.setName(e), this.setACL(r)) }
                        return a(t, e), o(t, [{ key: "getName", value: function() {
                                ...
                                if ("name" in e && e.name !== this.getName()) {
                                    var o = e.name;
                                    if (this.id && this.id !== e.objectId) return new c["default"](c["default"].OTHER_CAUSE, "A role's name can only be set before it has been saved.");
                                    if ("string" != typeof o) return new c["default"](c["default"].OTHER_CAUSE, "A role's name must be a String.");
                                    if (!/^[0-9a-zA-Z\-_ ]+$/.test(o)) return new c["default"](c["default"].OTHER_CAUSE, "A role's name can be only contain alphanumeric characters, _, -, and spaces.") }
            ...
            20: [function(e, t, r) {
                ...
                var u = e("./CoreManager"),
                    ...
                    g = function(e) {
                        function t(e) {
                            if (i(this, t), n(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, "_Session"), e && "object" == ("undefined" == typeof e ? "undefined" : _typeof(e)) && !this.set(e || {})) throw new Error("Can't create an invalid Session") }
                        return a(t, e), o(t, [{ key: "getSessionToken", value: function() {
                                ...
                                return e.hasOwnProperty("useMasterKey") && (r.useMasterKey = e.useMasterKey), m["default"].currentAsync().then(function(e) {
                                    return e ? (e.getSessionToken(), r.sessionToken = e.getSessionToken(), t.getSession(r)) : y["default"].error("There is no current user.") }) } }, { key: "isCurrentSessionRevocable", value: function() {
                                var e = m["default"].current();
                                return e ? (0, c["default"])(e.getSessionToken() || "") : !1 } }]), t }(h["default"]);
                r["default"] = g, h["default"].registerSubclass("_Session", g), l["default"].setSessionController({ getSession: function(e) {
            ...
            21: [function(e, t, r) {
                var n = e("babel-runtime/helpers/get")["default"],
                    ...
                    o = e("babel-runtime/helpers/create-class")["default"],
                    i = e("babel-runtime/helpers/class-call-check")["default"],
                    s = e("babel-runtime/core-js/object/define-property")["default"],
                    u = e("babel-runtime/helpers/interop-require-default")["default"],
                ...
                var f = e("./CoreManager"),
                    ...
                    k = u(S),
                    P = "currentUser",
                    j = !c["default"].get("IS_NODE"),
                    A = !1,
                    E = null,
                    T = {},
                    I = function(e) {
                        function t(e) {
                            if (i(this, t), n(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, "_User"), e && "object" == ("undefined" == typeof e ? "undefined" : _typeof(e)) && !this.set(e || {})) throw new Error("Can't create an invalid Parse User") }
                        return a(t, e), o(t, [{ key: "_upgradeToRevocableSession", value: function(e) { e = e || {};
                                var t = {};
                                e.hasOwnProperty("useMasterKey") && (t.useMasterKey = e.useMasterKey);
                                var r = c["default"].getUserController();
                                return r.upgradeToRevocableSession(this, t)._thenRunCallbacks(e) } }, { key: "_linkWith", value: function(e, t) {
                                var r, n = this;
                                if ("string" == typeof e ? (r = e, e = T[e]) : r = e.getAuthType(), t && t.hasOwnProperty("authData")) {
                                    var a = this.get("authData") || {};
                                    a[r] = t.authData;
                                    var o = c["default"].getUserController();
                                    return o.linkWith(this, a)._thenRunCallbacks(t, this) }
                                var i = new w["default"];
                                return e.authenticate({ success: function(e, r) {
                                        var a = {};
                                        a.authData = r, t.success && (a.success = t.success), t.error && (a.error = t.error), n._linkWith(e, a).then(function() { i.resolve(n) }, function(e) { i.reject(e) }) }, error: function(e, r) { t.error && t.error(n, r), i.reject(r) } }), i } }, { key: "_synchronizeAuthData", value: function(e) {
                                if (this.isCurrent() && e) {
                                    var t; "string" == typeof e ? (t = e, e = T[t]) : t = e.getAuthType();
                                    var r = this.get("authData");
                                    if (e && "object" == ("undefined" == typeof r ? "undefined" : _typeof(r))) {
                                ...
                                var r, n = this;
                                return "string" == typeof e ? (r = e, e = T[e]) : r = e.getAuthType(), this._linkWith(e, { authData: null }).then(function() {
                                ...
                                var e = this.get("authData");
                                if ("object" == ("undefined" == typeof e ? "undefined" : _typeof(e)))
                                    for (var t in e) this._logOutWith(t) } }, { key: "_logOutWith", value: function(e) { this.isCurrent() && ("string" == typeof e && (e = T[e]), e && e.deauthenticate && e.deauthenticate()) } }, { key: "isCurrent", value: function() {
                                var e = t.current();
                                ...
                                var n = c["default"].getUserController();
                                ...
                                for (var e = this, r = arguments.length, a = Array(r), o = 0; r > o; o++) a[o] = arguments[o];
                                return n(Object.getPrototypeOf(t.prototype), "save", this).apply(this, a).then(function() {
                                    return e.isCurrent() ? c["default"].getUserController().updateUserOnDisk(e) : e }) } }, { key: "fetch", value: function() {
                                for (var e = this, r = arguments.length, a = Array(r), o = 0; r > o; o++) a[o] = arguments[o];
                                return n(Object.getPrototypeOf(t.prototype), "fetch", this).apply(this, a).then(function() {
                                    return e.isCurrent() ? c["default"].getUserController().updateUserOnDisk(e) : e }) } }], [{ key: "readOnlyAttributes", value: function() {
                                return ["sessionToken"] } }, { key: "extend", value: function(e, r) {
                                if (e)
                                    for (var n in e) "className" !== n && s(t.prototype, n, { value: e[n], enumerable: !1, writable: !0, configurable: !0 });
                                if (r)
                                    for (var n in r) "className" !== n && s(t, n, { value: r[n], enumerable: !1, writable: !0, configurable: !0 });
                                return t } }, { key: "current", value: function() {
                                if (!j) return null;
                                var e = c["default"].getUserController();
                                return e.currentUser() } }, { key: "currentAsync", value: function() {
                                if (!j) return w["default"].as(null);
                                var e = c["default"].getUserController();
                                return e.currentUserAsync() } }, { key: "signUp", value: function(e, r, n, a) { n = n || {}, n.username = e, n.password = r;
                                var o = new t(n);
                                return o.signUp({}, a) } }, { key: "logIn", value: function(e, r, n) {
                                var a = new t;
                                return a._finishFetch({ username: e, password: r }), a.logIn(n) } }, { key: "become", value: function(e, t) {
                                if (!j) throw new Error("It is not memory-safe to become a user in a server environment");
                                t = t || {};
                                ...
                                if (!j) throw new Error("There is no current user user on a node.js server environment.");
                                var e = c["default"].getUserController();
                                return e.logOut() } }, { key: "requestPasswordReset", value: function(e, t) { t = t || {};
                                var r = {};
                                t.hasOwnProperty("useMasterKey") && (r.useMasterKey = t.useMasterKey);
                                var n = c["default"].getUserController();
                                return n.requestPasswordReset(e, r)._thenRunCallbacks(t) } }, { key: "allowCustomUserClass", value: function(e) { c["default"].set("PERFORM_USER_REWRITE", !e) } }, { key: "enableRevocableSession", value: function(e) {
                                if (e = e || {}, c["default"].set("FORCE_REVOCABLE_SESSION", !0), j) {
                                    var r = t.current();
                                    if (r) return r._upgradeToRevocableSession(e) }
                                return w["default"].as()._thenRunCallbacks(e) } }, { key: "enableUnsafeCurrentUser", value: function() { j = !0 } }, { key: "disableUnsafeCurrentUser", value: function() { j = !1 } }, { key: "_registerAuthenticationProvider", value: function(e) { T[e.getAuthType()] = e, t.currentAsync().then(function(t) { t && t._synchronizeAuthData(e.getAuthType()) }) } }, { key: "_logInWith", value: function(e, r) {
                                var n = new t;
                                return n._linkWith(e, r) } }, { key: "_clearCache", value: function() { E = null, A = !1 } }, { key: "_setCurrentUserCache", value: function(e) { E = e } }]), t }(_["default"]);
                r["default"] = I, _["default"].registerSubclass("_User", I);
                var N = {
                    updateUserOnDisk: function(e) {
                        var t = k["default"].generatePath(P),
                            r = e.toJSON();
                        return r.className = "_User", k["default"].setItemAsync(t, JSON.stringify(r)).then(function() {
                            return e }) },
                    setCurrentUser: function(e) {
                        return E = e, e._cleanupAuthData(), e._synchronizeAllAuthData(), N.updateUserOnDisk(e) },
                    currentUser: function() {
                        ...
                        var e = k["default"].generatePath(P),
                            t = k["default"].getItem(e);
                        if (A = !0, !t) return E = null, null;
                        ...
                        return E = r, r._synchronizeAllAuthData(), r },
                    currentUserAsync: function() {
                        if (E) return w["default"].as(E);
                        if (A) return w["default"].as(null);
                        var e = k["default"].generatePath(P);
                        return k["default"].getItemAsync(e).then(function(e) {
                            if (A = !0, !e) return E = null, w["default"].as(null);
                            ...
                            return E = t, t._synchronizeAllAuthData(), w["default"].as(t)
                        })
                    },
                    signUp: function(e, t, r) {
                        ...
                        return n && n.length ? a && a.length ? e.save(t, r).then(function() {
                            return e._finishFetch({ password: void 0 }), j ? N.setCurrentUser(e) : e }) : w["default"].error(new m["default"](m["default"].OTHER_CAUSE, "Cannot sign up user with an empty password.")) : w["default"].error(new m["default"](m["default"].OTHER_CAUSE, "Cannot sign up user with an empty name.")) },
                    logIn: function(e, t) {
                        var r = c["default"].getRESTController(),
                            n = { username: e.get("username"), password: e.get("password") };
                        return r.request("GET", "login", n, t).then(function(t, r) {
                            return e._migrateId(t.objectId), e._setExisted(!0), y.setPendingOp(e.className, e._getId(), "username", void 0), y.setPendingOp(e.className, e._getId(), "password", void 0), t.password = void 0, e._finishFetch(t), j ? N.setCurrentUser(e) : w["default"].as(e) }) },
                    become: function(e) {
                        var t = new I,
                            r = c["default"].getRESTController();
                    ...
                    upgradeToRevocableSession: function(e, t) {
                        ...
                        t.sessionToken = r;
                        var n = c["default"].getRESTController();
                    ...
                    linkWith: function(e, t) {
                        return e.save({ authData: t }).then(function() {
                            return j ? N.setCurrentUser(e) : e }) }
                };
                c["default"].setUserController(N), t.exports = r["default"]
            ...
            22: [function(e, t, r) {
                function n(e, t) {
                    if (t = t || {}, e.where && e.where instanceof u["default"] && (e.where = e.where.toJSON().where), e.push_time && "object" == _typeof(e.push_time) && (e.push_time = e.push_time.toJSON()), e.expiration_time && "object" == _typeof(e.expiration_time) && (e.expiration_time = e.expiration_time.toJSON()), e.expiration_time && e.expiration_interval) throw new Error("expiration_time and expiration_interval cannot both be set.");
                    return i["default"].getPushController().send(e, { useMasterKey: t.useMasterKey })._thenRunCallbacks(t) }
                var a = e("babel-runtime/helpers/interop-require-default")["default"];
                ...
                var o = e("./CoreManager"),
                    ...
                    s = e("./ParseQuery"),
                    u = a(s);
                i["default"].setPushController({ send: function(e, t) {
                        var r = i["default"].getRESTController(),
            ...
            23: [function(e, t, r) {
                (function(n) {
                    ...
                    var i = e("./CoreManager"),
                        ...
                        c = o(f),
                        d = e("./Storage"),
                        h = (o(d), null); "undefined" != typeof XMLHttpRequest && (h = XMLHttpRequest);
                    var p = !1; "undefined" == typeof XDomainRequest || "withCredentials" in new XMLHttpRequest || (p = !0);
                    var y = { ajax: function(e, t, r, o) {
                            if (p) return a(e, t, r, o);
                            var i = new c["default"],
                                u = 0,
                                l = function f() {
                                    ...
                                    l.onreadystatechange = function() {
                                        if (4 === l.readyState && !a)
                                            if (a = !0, l.status >= 200 && l.status < 300) {
                                                var e;
                                                try { e = JSON.parse(l.responseText) } catch (t) { i.reject(t.toString()) }
                                                e && i.resolve(e, l.status, l) } else if (l.status >= 500 || 0 === l.status)
                                            if (++u < s["default"].get("REQUEST_ATTEMPT_LIMIT")) {
                                                var r = Math.round(125 * Math.random() * Math.pow(2, u));
                                                setTimeout(f, r) } else 0 === l.status ? i.reject("Unable to connect to the Parse API") : i.reject(l);
                                        else i.reject(l) }, o = o || {}, o["Content-Type"] = "text/plain", s["default"].get("IS_NODE") && (o["User-Agent"] = "Parse/" + s["default"].get("VERSION") + " (NodeJS " + n.versions.node + ")"), l.open(e, t, !0);
                                    for (var c in o) l.setRequestHeader(c, o[c]);
                                    l.send(r) };
                            return l(), i }, request: function(e, t, r, n) { n = n || {};
                            var a = s["default"].get("SERVER_URL"); "/" !== a[a.length - 1] && (a += "/"), a += t;
                            var o = {};
                            if (r && "object" == ("undefined" == typeof r ? "undefined" : _typeof(r)))
                                for (var i in r) o[i] = r[i]; "POST" !== e && (o._method = e, e = "POST"), o._ApplicationId = s["default"].get("APPLICATION_ID"), o._JavaScriptKey = s["default"].get("JAVASCRIPT_KEY"), o._ClientVersion = s["default"].get("VERSION");
                            var u = n.useMasterKey;
                            if ("undefined" == typeof u && (u = s["default"].get("USE_MASTER_KEY")), u) {
                                if (!s["default"].get("MASTER_KEY")) throw new Error("Cannot use the Master Key, it has not been provided.");
                                delete o._JavaScriptKey, o._MasterKey = s["default"].get("MASTER_KEY") }
                            s["default"].get("FORCE_REVOCABLE_SESSION") && (o._RevocableSession = "1");
                            var f = s["default"].getInstallationController();
                            return f.currentInstallationId().then(function(e) { o._InstallationId = e;
                                var t = s["default"].getUserController();
                                return n && "string" == typeof n.sessionToken ? c["default"].as(n.sessionToken) : t ? t.currentUserAsync().then(function(e) {
                                    return e ? c["default"].as(e.getSessionToken()) : c["default"].as(null) }) : c["default"].as(null) }).then(function(t) { t && (o._SessionToken = t);
                                ...
                                return c["default"].error(t) }) }, _setXHR: function(e) { h = e } };
            ...
            24: [function(e, t, r) {
                ...
                t.exports = { async: function() {
                        ...
                        var t = o["default"].getStorageController();
                        return 1 === t.async ? t.getItemAsync(e) : s["default"].as(t.getItem(e)) }, setItem: function(e, t) {
                        ...
                        var r = o["default"].getStorageController();
                        return 1 === r.async ? r.setItemAsync(e, t) : s["default"].as(r.setItem(e, t)) }, removeItem: function(e) {
                        var t = o["default"].getStorageController();
                        if (1 === t.async) throw new Error("Synchronous storage is not supported by the current storage controller");
                        return t.removeItem(e) }, removeItemAsync: function(e) {
                        var t = o["default"].getStorageController();
                        return 1 === t.async ? t.removeItemAsync(e) : s["default"].as(t.removeItem(e)) }, generatePath: function(e) {
                        ...
                        return "/" === e[0] && (e = e.substr(1)), "Parse/" + o["default"].get("APPLICATION_ID") + "/" + e }, _clear: function() {
                        var e = o["default"].getStorageController();
                        e.hasOwnProperty("clear") && e.clear() } }, o["default"].setStorageController(e("./StorageController.browser")) }, { "./CoreManager": 3, "./ParsePromise": 16, "./StorageController.browser": 25, "babel-runtime/helpers/interop-require-default": 47 }],
            25: [function(e, t, r) {
                var n = e("babel-runtime/helpers/interop-require-default")["default"],
                    a = e("./ParsePromise");
                n(a), t.exports = { async: 0, getItem: function(e) {
            ...
            26: [function(e, t, r) {
                ...
                t.exports = function() {
                    ...
                    return n(e, [{ key: "enqueue", value: function(e) {
                            var t = this,
                                r = new s["default"];
                            return this.queue.push({ task: e, _completion: r }), 1 === this.queue.length && e().then(function() { t._dequeue(), r.resolve() }, function(e) { t._dequeue(), r.reject(e) }), r } }, { key: "_dequeue", value: function() {
                            var e = this;
                            if (this.queue.shift(), this.queue.length) {
                                var t = this.queue[0];
                                t.task().then(function() { e._dequeue(), t._completion.resolve() }, function(r) { e._dequeue(), t._completion.reject(r) }) } } }]), e }() }, { "./ParsePromise": 16, "babel-runtime/helpers/class-call-check": 43, "babel-runtime/helpers/create-class": 44, "babel-runtime/helpers/interop-require-default": 47 }],
            27: [function(e, t, r) {
                function n(e, t) {
                    if (e.indexOf(t) > -1) return !0;
                    for (var r = 0; r < e.length; r++)
                        if (e[r] instanceof i["default"] && e[r].className === t.className && e[r]._getId() === t._getId()) return !0;
                    return !1 }
                var a = e("babel-runtime/helpers/interop-require-default")["default"];
            ...
            28: [function(e, t, r) {
                ...
                function a(e) {
                    if ("object" != ("undefined" == typeof e ? "undefined" : _typeof(e))) return !0;
                    if (e instanceof c["default"]) return !0;
                    if (e instanceof l["default"]) return !!e.id;
                    if (e instanceof s["default"]) return e.url() ? !0 : !1;
                    if (Array.isArray(e)) {
            ...
            29: [function(e, t, r) {
                function n(e) {
                    if (null === e || "object" != ("undefined" == typeof e ? "undefined" : _typeof(e))) return e;
                    if (Array.isArray(e)) {
                        var t = [];
                        return e.forEach(function(e, r) { t[r] = n(e) }), t }
                    if ("string" == typeof e.__op) return (0, d.opFromJSON)(e);
                    if ("Pointer" === e.__type && e.className) return c["default"].fromJSON(e);
                    if ("Object" === e.__type && e.className) return c["default"].fromJSON(e);
            ...
            30: [function(e, t, r) {
                function n(e, t, r, o) {
                    if (e instanceof h["default"]) {
                        ...
                        var i = e.id ? e.className + ":" + e.id : e;
                        return r || !o || o.indexOf(i) > -1 || e.dirty() || a(e._getServerData()).length < 1 ? e.toPointer() : (o = o.concat(i), e._toFullJSON(o)) }
                    if (e instanceof p.Op || e instanceof s["default"] || e instanceof c["default"] || e instanceof v["default"]) return e.toJSON();
                    ...
                    if (e && "object" == ("undefined" == typeof e ? "undefined" : _typeof(e))) {
                        var u = {};
                        for (var f in e) u[f] = n(e[f], t, r, o);
                        return u }
                    return e }
            ...
            31: [function(e, t, r) {
                function n(e, t) {
                    if (("undefined" == typeof e ? "undefined" : _typeof(e)) != ("undefined" == typeof t ? "undefined" : _typeof(t))) return !1;
                    if (!e || "object" != ("undefined" == typeof e ? "undefined" : _typeof(e))) return e === t;
                    if (Array.isArray(e) || Array.isArray(t)) {
                        ...
                        return !0 }
                    if (e instanceof s["default"] || e instanceof l["default"] || e instanceof c["default"] || e instanceof h["default"]) return e.equals(t);
            ...
            34: [function(e, t, r) {
                function n(e) {
                    ...
                    var n = r[1] || 0,
                        ...
                        u = r[6] || 0,
                        l = r[8] || 0;
                    return new Date(Date.UTC(n, a, o, i, s, u, l)) }
                Object.defineProperty(r, "__esModule", { value: !0 }), r["default"] = n, t.exports = r["default"] }, {}],
            35: [function(e, t, r) {
                function n(e) {
                    var t = [];
                    return e.forEach(function(e) { e instanceof u["default"] ? (0, i["default"])(t, e) || t.push(e) : t.indexOf(e) < 0 && t.push(e) }), t }
                var a = e("babel-runtime/helpers/interop-require-default")["default"];
                Object.defineProperty(r, "__esModule", { value: !0 }), r["default"] = n;
                var o = e("./arrayContainsObject"),
                    i = a(o),
                    s = e("./ParseObject"),
                    u = a(s);
            ...
            36: [function(e, t, r) {
                function n(e, t) {
                    ...
                    var o = e.attributes;
                    for (var i in o) "object" == _typeof(o[i]) && a(o[i], r, !1, !!t);
                    var s = [];
                    for (var u in r.objects) u !== n && r.objects[u] !== !0 && s.push(r.objects[u]);
                    return s.concat(r.files) }

                function a(e, t, r, n) {
                    if (e instanceof l["default"]) {
                        if (!e.id && r) throw new Error("Cannot create a pointer to an unsaved Object.");
                        var o = e.className + ":" + e._getId();
                        if (!t.objects[o]) { t.objects[o] = e.dirty() ? e : !0;
                            var i = e.attributes;
                            for (var u in i) "object" == _typeof(i[u]) && a(i[u], t, !n, n) } } else {
                        if (e instanceof s["default"]) return void(!e.url() && t.files.indexOf(e) < 0 && t.files.push(e));
                        if (!(e instanceof c["default"])) { Array.isArray(e) && e.forEach(function(e) { a(e, t, r, n) });
                            for (var f in e) "object" == _typeof(e[f]) && a(e[f], t, r, n) } } }
                var o = e("babel-runtime/helpers/interop-require-default")["default"];
                Object.defineProperty(r, "__esModule", { value: !0 }), r["default"] = n;
                var i = e("./ParseFile"),
                    s = o(i),
            ...
            43: [function(e, t, r) { r["default"] = function(e, t) {
            ...
            45: [function(e, t, r) {
                ...
                r["default"] = function(e, t, r) {
                    for (var a = !0; a;) {
                        ...
                        if (null === f) return;
                        e = f, t = i, r = s, a = !0, u = f = void 0 } }, r.__esModule = !0 }, { "babel-runtime/core-js/object/get-own-property-descriptor": 40 }],
            46: [function(e, t, r) {
            ...
            47: [function(e, t, r) { r["default"] = function(e) {
                    return e && e.__esModule ? e : { "default": e } }, r.__esModule = !0 }, {}],
            48: [function(e, t, r) { r["default"] = function(e) {
                ...
                var n = e("./$.global"),
                    ...
                    s = function u(e, t, r) {
                        var s, l, f, c = e & u.F,
                            ...
                            g = d ? n : h ? n[t] : (n[t] || {})[i];
                        d && (r = t);
                        for (s in r) l = !c && g && s in g, l && s in m || (f = l ? g[s] : r[s], m[s] = d && "function" != typeof g[s] ? r[s] : y && l ? o(f, n) : v && g[s] == f ? function(e) {
                            var t = function(t) {
                                return this instanceof e ? new e(t) : e(t) };
                            return t[i] = e[i], t }(f) : p && "function" == typeof f ? o(Function.call, f) : f, p && ((m[i] || (m[i] = {}))[s] = f)) };
                s.F = 1, s.G = 2, s.S = 4, s.P = 8, s.B = 16, s.W = 32, t.exports = s }, { "./$.core": 58, "./$.ctx": 59, "./$.global": 63 }],
            ...
            67: [function(e, t, r) {
                ...
                t.exports = function(e, t) {
                    var r = (a.Object || {})[e] || Object[e],
                        i = {};
                    i[e] = t(r), n(n.S + n.F * o(function() { r(1) }), "Object", i) } }, { "./$.core": 58, "./$.export": 61, "./$.fails": 62 }],
            68: [function(e, t, r) {
                var n = e("./$").getDesc,
                    a = e("./$.is-object"),
                    o = e("./$.an-object"),
                ...
                t.exports = { set: Object.setPrototypeOf || ("__proto__" in {} ? function(t, r, a) {
                        try { a = e("./$.ctx")(Function.call, n(Object.prototype, "__proto__").set, 2), a(t, []), r = !(t instanceof Array) } catch (o) { r = !0 }
                        return function(e, t) {
                            return i(e, t), r ? e.__proto__ = t : a(e, t), e } }({}, !1) : void 0), check: i } }, { "./$": 66, "./$.an-object": 56, "./$.ctx": 59, "./$.is-object": 65 }],
            69: [function(e, t, r) {
                var n = e("./$.iobject"),
                    a = e("./$.defined");
                t.exports = function(e) {
    ...
    function() {
        ...
        e = function() {
            ...
            return t.fn.kudoable = function() {
                return this.each(function() {
                    return new e(t(this)) }) } }) }.call(void 0);
